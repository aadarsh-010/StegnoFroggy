        ...
        <div className="Contt" >
          <Fade direction="left"  triggerOnce="true" duration="1500" >
            ...
            <div className="image-sectionab margincorrection">
                <img src="..\..\public\history1.webp"  style={{ "margin-top": "0px"}} / >
            </div>
            </Fade>
        </div>
        ...
        <div className="Contt" >
          <Fade direction="right"  triggerOnce="true" duration="1500" >
            ...
            <div className="image-sectionab">
                <img src="..\..\public\imagestag.jpeg" style={{ "margin-top": "0px"}}/>
            </div>
            </Fade>
        </div>
      ...
      <div className="sectionab">
        <div className="Contt" >
          <Fade direction="left"  triggerOnce="true" duration="1500" >
            ...
            <Fade direction="right"  triggerOnce="true" duration="1500">
            <div className="image-sectionab margincorrection">
                <img src="..\..\public\secuirty_badge.jpg" style={{ "margin-top": "0px"}}/>
            </div>
            </Fade>
        </div>
